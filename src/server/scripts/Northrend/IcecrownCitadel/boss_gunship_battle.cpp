 ...
 * Copyright (C) 2012-2012 Terabyte <http://www.naga-wow.com/>
 *
    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* pCreature)
        {
            ...
            if (pInstance && pInstance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
            {
                ...
                player->ADD_GOSSIP_ITEM(0, "We are all prepared Muradin. Come on!", 631, 1001);
        ...
        bool OnGossipSelect(Player* player, Creature* pCreature, uint32 /*sender*/, uint32 action)
        {
            ...
            if (action == GOSSIP_ACTION_INFO_DEF+2)
                pCreature->MonsterSay("Wait for the leader of the raid.", LANG_UNIVERSAL, player->GetGUID());
    ...
    public:
        ...
        bool OnGossipHello(Player* pPlayer, Creature* pCreature)
        {
            ...
            if (pPlayer->GetItemCount(49278, false) == 0)
                pPlayer->ADD_GOSSIP_ITEM(0, "Yes, I believe that safety is the priority. Give me a Backpack Rocket.", 631, 1);
        ...
        bool OnGossipSelect(Player* player, Creature* pCreature, uint32 /*sender*/, uint32 action)
        {
            ...
            if (action == 1)
            {
                ...
                if (curItemCount >= 1)
                {
                    pCreature->MonsterWhisper("Already have the jetpack!", player->GetGUIDLow());
                    return false;
                }
                ...
                {
                    pCreature->MonsterWhisper("You do not have enough free space to recive the rocket pack!", player->GetGUIDLow());
                    return false;
                }
            }
